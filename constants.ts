...
Place an orange baseball cap on their head (similar to a MAGA hat style).
On the front of the cap, write the text "MAKE BONK" on the top line and "GREAT AGAIN" on the bottom line in white, bold, legible text.
Ensure the cap fits naturally on the head. Maintain the original background.
`;
